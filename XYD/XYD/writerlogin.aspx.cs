...
namespace XYD
{
    public partial class writerlogin : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "select * from Writer where PhoneNumber ='" + user + "' and Password ='" + password + "'";
            ...
            OdbcDataReader mywriter = odbcCmd.ExecuteReader();
            if (mywriter.Read())
            {
                //Label1.Text = "您好，登陆成功";
                Session["Writername"] = mywriter.GetValue(mywriter.GetOrdinal("WriteNmae"));//获取该作者的笔名
                Page.Response.Redirect("writer.aspx");
