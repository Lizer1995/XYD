<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertBook.aspx.cs" Inherits="XYD.InsertBook" %>
...
<div id="div0" class="row" style="margin:5px">
   ...
   <div id="div2" class="col-md-8 col-xs-12 col-sm-10">
     ...
     <p>  
        分类：<asp:RadioButtonList ID="xuanze" runat="server">
            <asp:ListItem Value="古代&穿越" Selected="True" Text="古代&穿越" />  
            <asp:ListItem Value="现代&言情" Text="现代&言情" />  
            <asp:ListItem Value="玄幻&悬疑" Text="玄幻&悬疑" /> 
         </asp:RadioButtonList>
    </p>  
     <div>
        简介：<br />
          <asp:TextBox ID="TextBox2" style="width:100%;height:10em" runat="server" TextMode="MultiLine"></asp:TextBox>
     </div>
